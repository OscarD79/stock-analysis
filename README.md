...
### The stock analysis focuses on the Daily Volume of each stock and the Percentage of the return on the year. In 2017, all but one stock had increased. Four stocks had increased by over 100%. The single stock that had a decreased return decreased by less than 10%. For 2017, the refactored script took 0.517 seconds to load as opposed to the original script which ran in 0.53 seconds. See the below screenshot for a reference for the refactored code.
